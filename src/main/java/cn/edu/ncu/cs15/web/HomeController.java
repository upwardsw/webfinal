...
public class HomeController {
    ...
    @RequestMapping(value = "/addNewFriendRequest", method = {RequestMethod.POST, RequestMethod.GET})
    private String addNewFriendRequest(@RequestParam("friendId") String friendId, HttpServletRequest request) {
        String currentId = (String) request.getSession().getAttribute("currentId");
        homeService.addNewFriendRequest(currentId, friendId);
        return "redirect:/view/home";
    }

    @RequestMapping(value = "/agreeNewFriend", method = {RequestMethod.POST, RequestMethod.GET})
    private String agreeNewFriend(@ModelAttribute("currentId") String currentId, @RequestParam("friendId") String friendId, HttpServletRequest request) {
    ...
    private String deleteFriend(@ModelAttribute("currentId") String currentId, @RequestParam("friendId") String friendId, HttpServletRequest request) {
        homeService.deleteFriend(currentId, friendId);
        return "redirect:/view/managerFriend";
    }

    @RequestMapping(value = "/updateSelfInformation", method = {RequestMethod.POST, RequestMethod.GET})
    ...
    @RequestMapping(value = "/chatHistory", method = {RequestMethod.POST, RequestMethod.GET})
